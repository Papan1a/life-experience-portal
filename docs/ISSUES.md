...
2. подумать над возможностью давать роли пользователям которые будут изменять их возможности - администратор (может все), обычный пользователь - может предлагать варианты активностей, но не может менять старые
